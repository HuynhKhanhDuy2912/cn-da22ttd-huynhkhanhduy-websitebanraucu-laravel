...
function init_sparklines() {
    void 0 !== jQuery.fn.sparkline &&
        ...
        $(".sparkline_one").sparkline(
            [
                2, 4, 3, 4, 5, 4, 5, 4, 3, 4, 5, 6, 4, 5, 6, 3, 5, 4, 5, 4, 5,
                4, 3, 4, 5, 6, 7, 5, 4, 3, 5, 6,
            ],
            {
                type: "bar",
                height: "125",
...
function init_validator() {
    "undefined" != typeof validator &&
        ...
        $("form").submit(function (e) {
            ...
            var a = !0;
            return (
                validator.checkAll($(this)) || (a = !1), a && this.submit(), !1
            );
        }));
}
...
function init_echarts() {
    if ("undefined" != typeof echarts) {
        ...
        var e = {
            ...
            force: {
                itemStyle: {
                    normal: { linkStyle: { strokeColor: "#408829" } },
                },
            },
            chord: {
                padding: 4,
                ...
                series: [
                    {
                        ...
                        type: "bar",
                        data: [
                            2, 4.9, 7, 23.2, 25.6, 76.7, 135.6, 162.2, 32.6, 20,
                            6.4, 3.3,
                        ],
                        markPoint: {
                            data: [
                    ...
                    },
                    {
                        ...
                        type: "bar",
                        data: [
                            2.6, 5.9, 9, 26.4, 28.7, 70.7, 175.6, 182.2, 48.7,
                            18.8, 6, 2.3,
                        ],
                        markPoint: {
                            data: [
        ...
        if ($("#echart_pyramid").length)
            echarts
                .init(document.getElementById("echart_pyramid"), e)
                .setOption({
                    title: {
        ...
        if ($("#echart_scatter").length)
            echarts
                .init(document.getElementById("echart_scatter"), e)
                .setOption({
