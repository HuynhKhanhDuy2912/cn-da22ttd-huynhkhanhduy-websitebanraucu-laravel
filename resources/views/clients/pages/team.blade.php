        ...
        <div class="row justify-content-center">
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
                <div class="ltn__team-item">
                    ...
                    <div class="team-info">
                        ...
                        <h4><a href="{{route('contact.index')}}">Kelian Anderson</a></h4>
                        <div class="ltn__social-media">
                            <ul>
                                <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                                <li><a href="#"><i class="fab fa-twitter"></i></a></li>
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
                <div class="ltn__team-item">
                    ...
                    <div class="team-info">
                        ...
                        <h4><a href="{{route('contact.index')}}">Miranda H. Halim</a></h4>
                        <div class="ltn__social-media">
                            <ul>
                                <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                                <li><a href="#"><i class="fab fa-twitter"></i></a></li>
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
                <div class="ltn__team-item">
                    ...
                    <div class="team-info">
                        <h6 class="ltn__secondary-color">Organic Farmer</h6>
                        <h4><a href="{{route('contact.index')}}">Damble D. Browni.</a></h4>
                        <div class="ltn__social-media">
                            <ul>
                                <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                                <li><a href="#"><i class="fab fa-twitter"></i></a></li>
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
                <div class="ltn__team-item">
                    ...
                    <div class="team-info">
                        <h6 class="ltn__secondary-color"> Organic Farmer </h6>
                        <h4><a href="{{route('contact.index')}}">Mark D. Kelvin</a></h4>
                        <div class="ltn__social-media">
                            <ul>
                                <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                                <li><a href="#"><i class="fab fa-twitter"></i></a></li>
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
                <div class="ltn__team-item">
                    ...
                    <div class="team-info">
                        <h6 class="ltn__secondary-color"> Organic Farmer </h6>
                        <h4><a href="{{route('contact.index')}}">James Anderson</a></h4>
                        <div class="ltn__social-media">
                            <ul>
                                <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                                <li><a href="#"><i class="fab fa-twitter"></i></a></li>
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
                <div class="ltn__team-item">
                    ...
                    <div class="team-info">
                        <h6 class="ltn__secondary-color">Organic Farmer</h6>
                        <h4><a href="{{route('contact.index')}}">Miranda Robert</a></h4>
                        <div class="ltn__social-media">
                            <ul>
                                <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                                <li><a href="#"><i class="fab fa-twitter"></i></a></li>
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
                <div class="ltn__team-item">
                    <div class="team-img">
                        <img src="{{asset('assets/clients/img/team/8.jpg')}}" alt="Image" height="267">
                    </div>
                    <div class="team-info">
                        <h6 class="ltn__secondary-color">Organic Farmer</h6>
                        <h4><a href="{{route('contact.index')}}">Emily</a></h4>
                        <div class="ltn__social-media">
                            <ul>
                                <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                                <li><a href="#"><i class="fab fa-twitter"></i></a></li>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 align-self-center">
                <div class="about-img-right">
                    <img src="{{ asset('assets/clients/img/team/t-4.jpg') }}" alt="Đội ngũ làm việc">
                </div>
            </div>
        </div>
    </div>
