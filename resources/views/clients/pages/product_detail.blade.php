                ...
                <div class="col-lg-12 col-md-12">
                                    ...
                                    <div class="ltn__product-details-menu-3">
                                        <ul>
                                            <li style="margin-right: 198px">
                                                <span style="font-weight: 500">Còn lại: </span><span>{{$product->stock}} sản phẩm</span><br>
                                            </li>
                                            <li>
                    ...
                    <div class="ltn__shop-details-tab-inner ltn__shop-details-tab-inner-2">
                        <div class="ltn__shop-details-tab-menu">
                            <div class="nav">
                                <a class="active show" data-bs-toggle="tab" href="#liton_tab_details_description">Mô tả sản phẩm</a>
                                <a data-bs-toggle="tab" href="#liton_tab_details_review" class="">Đánh giá sản phẩm</a>
                            </div>
                        </div>
