                                ...
                                <div class="slide-item-info">
                                    <div class="slide-item-info-inner ltn__slide-animation">
                                        ...
                                        <h6 class="slide-sub-title animated"><img
                                                src="{{ asset('assets/clients/img/icons/icon-img/1.png') }}" alt="#"><span style="vertical-align: bottom">Rau củ tươi ngon mỗi ngày</span></h6>
                                        <h1 class="slide-title animated ">Trải nghiệm hương vị <br> tự nhiên từ nông trại</h1>
                                        <div class="slide-brief animated">
                                            <p>Chúng tôi mang đến những loại rau củ tươi sạch, an toàn và giàu dinh dưỡng, trực tiếp từ nông tại trại đến bàn ăn của bạn.</p>
                                        </div>
                                        <div class="btn-wrapper animated">
                                            <a href="shop.html" class="theme-btn-1 btn btn-effect-1 text-uppercase">Khám phá ngay</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12 align-self-center">
                                <div class="slide-item-info">
                                    <div class="slide-item-info-inner ltn__slide-animation">
                                        ...
                                        <div class="slide-brief animated">
                                            <p>Chúng tôi cung cấp rau củ sạch giàu dinh dưỡng, được trồng theo phương pháp hữu cơ, đảm bảo an toàn cho sức khỏe.</p>
                                        </div>
                                        <div class="btn-wrapper animated">
                                            <a href="shop.html" class="theme-btn-1 btn btn-effect-1 text-uppercase">Khám phá ngay</a>
                                ...
                                <div class="slide-item-img slide-img-left">
                                    <img src="{{ asset('assets/clients/img/slider/22.png')}}" alt="#">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="tab-content">
                        @foreach ($categories as $item => $category)
                            <div class="tab-pane fade {{ $item == 0 ? 'active show' : '' }}"
                                id="tab_{{ $category->id }}">
