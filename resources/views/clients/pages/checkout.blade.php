                    ...
                    <div class="ltn__checkout-inner">
                        <div class="ltn__checkout-single-content mt-50">
                            ...
                            <div class="select-address">
                                ...
                                <div>
                                    <a href="{{ route('account') }}" class="btn theme-btn-1 btn-effect-1 text-uppercase" id="btn-new-address">Thêm địa chỉ mới</a>
                                </div>
                            </div>
                    ...
                    <div class="ltn__checkout-payment-method mt-50">
                        ...
                        <form action="" method="POST">
                            ...
                            <div id="checkout_payment">
                                <div class="card">
                                    <h5 class="ltn__card-title">
                                        ...
                                        <label for="payment_cod">Thanh toán khi nhận hàng
                                ...
                                <div class="card">
                                    <h5 class="collapsed ltn__card-title">
                                        ...
                                        <label for="payment_paypal">PayPal
                            ...
                            <div class="ltn__payment-note mt-30 mb-30">
                                <p>Dữ liệu cá nhân của bạn sẽ được sử dụng để xử lý đơn hàng, hỗ trợ trải nghiệm của bạn trên 
                                toàn bộ trang web này và cho các mục đích khác được mô tả trong chính sách bảo mật của chúng tôi.</p>
                            </div>
